      ...
      <CardContent>
        <form>
          <div className="grid w-full items-center gap-4">
            ...
            <div className="flex flex-col space-y-1.5">
              <textarea id="body" placeholder="What's in your mind?" onChange={(e) => setPostBody(e.target.value)} className="h-[350px] bg-white font-lg border-none focus:outline-none ring-none"/>
            </div>
          </div>
        </form>
      </CardContent>
